...
public class LoginScreen extends Activity {
							...
							public void onFinish() {
							    ...
							    builder.setNegativeButton("Access Data", new DialogInterface.OnClickListener() {
							        ...
							        public void onClick(DialogInterface dialog, int which) {
							            // Go to maps screen
							            dialog.dismiss();
							            Intent intent = new Intent(mActivity, RoutesActivity.class);
							            //HOSSEIN: What is the screen we go to here, instead of MapListScreen.class?
							            intent.putExtra("validated", false); //use validated false to hide the new run button
					...
					public void onFinish() {
					    ...
					    builder.setNegativeButton("Access Data", new DialogInterface.OnClickListener() {
					        ...
					        public void onClick(DialogInterface dialog, int which) {
					            ...
					            Intent intent = new Intent(mActivity, RoutesActivity.class);
					          //HOSSEIN: What is the screen we go to here, instead of MapListScreen.class?
					            intent.putExtra("validated", false); //hide the new run button
					            intent.putExtra("nymiHandle", -1);
				                startActivity(intent);
					        }
					    });
		    		...
		    		public void onFinish() {
					    ...
					    builder.setNegativeButton("Access Data", new DialogInterface.OnClickListener() {
					        ...
					        public void onClick(DialogInterface dialog, int which) {
					            ...
					            Intent intent = new Intent(mActivity, RoutesActivity.class);
					          //HOSSEIN: What is the screen we go to here, instead of MapListScreen.class?
				                intent.putExtra("validated", false); //hide new run button
				                intent.putExtra("nymiHandle", -1);
				                startActivity(intent);
					        }
					    });
	...
	@SuppressLint("SdCardPath")
	public static void appendLog(String text1, String text2) //LoginScreen.appendLog("", 
	{      
		Log.d(text1, text2);
